...
incomplete_gp <- hcq_monthly_quantity_gp_pre_cv19 %>% 
    as_tibble() %>% 
    group_by(regional_unit) %>% 
    count() %>% 
    filter(n < 50) %>% 
...
# mplus.view.plots("../mplus_analyses/hcq_gp/hcq_discrep_5_class_ml.gh5")
mplus.plot.estimated_means("../mplus_analyses/hcq_gp/hcq_discrep_5_class_ml.gh5")
```
#### kmeans
